...
function renderMessage(msg: ChatMessage): string {
  ...
  return `
    <div class="msg msg-bap">
      <div class="label label-bap">Skillet</div>
...
<title>Skillet Chat — ${escapeHtml(ts)}</title>
<style>
  :root {
    --bg: #1a1714;
    --surface: #22201c;
...
<body>
  <div class="container">
    <header>
      <h1>Skillet Chat Export</h1>
      <span class="subtitle">${escapeHtml(ts)}</span>
    </header>
${body}
    <footer>
      Generated by Skillet · ${messages.length} message${messages.length === 1 ? "" : "s"}
    </footer>
  </div>
</body>
</html>
